...
class Core {
    ...
    function setReporting() {
        if (APP_DEBUG === true) {
            ...
            ini_set('error_log', RUNTIME_PATH. 'logs'. DS .'error.log');
        }
    }
    // 删除敏感字符
    ...
    static function loadClass($class) {
        ...
        $controllers = APP_PATH . 'application'. DS .'controllers' . DS . $class . '.class.php';
        $models = APP_PATH . 'application' . DS . 'models' . DS . $class . '.class.php';
